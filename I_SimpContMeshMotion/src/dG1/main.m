...
%     U_q2p = A_mat_q2p\b_vec_q2p;
    ...
    figure(2)
    PlotSolutiondG1(Un, Unm1p, x0, G, Gnm1, amin, amax, bmin, bmax, ...
                                    tna, tnm1a, tnb, tnm1b)
...
%     figure(2)
%     PlotSolutiondG1(Uan, Uanm1, x0, G, Gnm1, amin, amax, bmin, bmax, ...
%                                     tna, tnm1a, tnb, tnm1b)
      
%     figure(2)    
%     PlotSolutiondG1(U_q2p, x0, G, Gnm1, amin, amax, bmin, bmax, ...
%                                     tna, tnm1a, tnb, tnm1b)
%     hold on
...
% FE-Sol err, Ua - U
error_quad3GL = ErrorL2NormSpace(Un, @(x)(u_func(x, tn)), x0, G)

error_quadTrapezoidal = ErrorL2NormSpaceQuadTrapezoidal(Un, Uan, x0, G, a, b)
    
%     ex_err = Uan(acno0 == acno) - Un(acno0 == acno);
...
% disp(' --- THE ERRORS --- ');
% 
% disp('L2-norm of the error of the exact dG(1)-FE-solution'); 
% disp([num2str(error)]);
% disp(' ');
