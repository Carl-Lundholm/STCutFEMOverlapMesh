...
%     error_vec = DATA(2*mu_instance + 1, :);
    ...
    cfun_error = polyfit(kn_veclog10(lls_si:lls_ei), error_veclog10(lls_si:lls_ei),1)
    ...
    hold on
    loglog(kn_vec(lls_si:lls_ei), 10.^(polyval(cfun_error, kn_veclog10(lls_si:lls_ei))),'r-', 'Linewidth', 4)
