function A_git = GammaIntegralTermdG1(K0, KG, x0, mutr, C, t1ga, t1gb, ...
...
A_git = GaInTedG1_AuxiliaryFunc(A_git, Kgs_left, x0, tg, nt, nx, ...
...
A_git = GaInTedG1_AuxiliaryFunc(A_git, Kgs_right, x0, tg, nt, nx, ...
